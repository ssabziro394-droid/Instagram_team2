  ...
  return (
    <div className="flex flex-col gap-3 w-full animate-fade-in">
      ...
      <div className="w-full border border-zinc-800 rounded bg-black px-9 py-10 flex flex-col items-center">
        ...
        <div className="mb-4 mt-2 flex justify-center text-white w-44">
          <svg
        ...
        <p className="text-zinc-400 text-sm font-semibold text-center mb-6 max-w-[240px] leading-snug">
        ...
        >
          ...
          <div className="flex flex-col w-full relative">
            <input
              ...
              placeholder=" "
              {...register("email")}
              className={`peer w-full bg-zinc-950 text-white text-[12px] px-2.5 pt-4 pb-1 rounded border ${errors.email ? "border-red-500 focus:border-red-500" : "border-zinc-800 focus:border-zinc-500"} focus:outline-none transition-all placeholder-transparent h-[38px]`}
            />
          ...
          <div className="flex flex-col w-full relative">
            <input
              ...
              placeholder=" "
              {...register("fullName")}
              className={`peer w-full bg-zinc-950 text-white text-[12px] px-2.5 pt-4 pb-1 rounded border ${errors.fullName ? "border-red-500 focus:border-red-500" : "border-zinc-800 focus:border-zinc-500"} focus:outline-none transition-all placeholder-transparent h-[38px]`}
            />
            <span className="absolute left-2.5 top-2.5 text-zinc-500 text-[12px] transition-all origin-left pointer-events-none peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-2.5 peer-focus:scale-75 peer-[:not(:placeholder-shown)]:-translate-y-2.5 peer-[:not(:placeholder-shown)]:scale-75 select-none">
              Имя и фамилия
            </span>
          ...
          <div className="flex flex-col w-full relative">
            <input
              ...
              className={`peer w-full bg-zinc-950 text-white text-[12px] px-2.5 pt-4 pb-1 rounded border ${errors.confirmPassword ? "border-red-500 focus:border-red-500" : "border-zinc-800 focus:border-zinc-500"} focus:outline-none transition-all placeholder-transparent h-[38px]`}
            />
            <span className="absolute left-2.5 top-2.5 text-zinc-500 text-[12px] transition-all origin-left pointer-events-none peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-2.5 peer-focus:scale-75 peer-[:not(:placeholder-shown)]:-translate-y-2.5 peer-[:not(:placeholder-shown)]:scale-75 select-none">
              Подтвердите пароль
            </span>
